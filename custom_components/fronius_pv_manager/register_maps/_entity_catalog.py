...
_SUGGESTED_OBJECT_IDS: dict[int, dict[str, str]] = {
    ...
    123: {
        ...
        "Conn": "inverter_reg_connection_control",
        ...
        "WMaxLim_Ena": "inverter_reg_power_limit_enable",
        ...
        "OutPFSet_Ena": "inverter_reg_power_factor_enable",
        ...
        "VArPct_Ena": "inverter_reg_reactive_power_enable",
        "VArPct_Mod": "reactive_power_limit_mode",
    },
    124: {
        "StorCtl_Mod": "storage_reg_control_mode",
